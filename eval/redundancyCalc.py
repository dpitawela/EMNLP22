...
if __name__ == "__main__":
    ...
    def parameter_tuning(common_corpus, common_dictionary, common_texts):
        ...
        for i in range(2, 3):
            lda = gensim.models.LdaMulticore(common_corpus, id2word=common_dictionary, workers=5, num_topics=i,
                                             chunksize=100, passes=1, random_state=100)
        ...
        alphas = []
        for i in alpha:
            lda = gensim.models.LdaMulticore(common_corpus, id2word=common_dictionary, alpha=i, workers=5, num_topics=n_o_t,
                                             chunksize=100, passes=10, random_state=100)
            coherence_model_lda = CoherenceModel(model=lda, texts=common_texts, dictionary=common_dictionary,
                                                 coherence='c_v')
            coherence_lda = coherence_model_lda.get_coherence()
            #         print("Alpha :",i)
        ...
        etas = []
        for i in eta:
            lda = gensim.models.LdaMulticore(common_corpus, id2word=common_dictionary, alpha=alpha_val, eta=i, workers=5,
                                             num_topics=n_o_t, chunksize=100, passes=10, random_state=100)
            coherence_model_lda = CoherenceModel(model=lda, texts=common_texts, dictionary=common_dictionary,
                                                 coherence='c_v')
            coherence_lda = coherence_model_lda.get_coherence()
            #         print("Etas :",i)
    ...
    final_lda = gensim.models.LdaMulticore(common_corpus, id2word=common_dictionary, alpha=a, eta=e, workers=5,
                                           num_topics=n, chunksize=100, passes=10, random_state=100)
