...
def train(args,device_id):
    ...
    def train_iter_fct():
        return data_loader.AbstractiveDataloader(args, load_dataset(args, 'train', True, spm), symbols, args.batch_size, device,
...
def validate(args, device_id, pt, step):
    ...
    valid_iter = data_loader.AbstractiveDataloader(args, load_dataset(args, 'valid', False, spm), symbols,
...
def test(args, pt, step):
    ...
    test_iter = data_loader.AbstractiveDataloader(args, load_dataset(args, args.dataset, False, spm), symbols,
